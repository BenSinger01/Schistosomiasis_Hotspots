...
,"all_COTKEN","all_KENTAN","all_TANCOT"]:
	...
	for target in clas_targets:
		...
		# Figures
			...
			plt.savefig(folder+var+val+validation_approach+"Trained_Models/LogisticRegression_"
		...
		with open(folder+var+val+validation_approach+"Trained_Models/LogisticRegression_"
